...
Pod::Spec.new do |s|
  s.name             = 'IAR-UI'
  s.version          = '1.6.23-beta2'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/0a665b1cf9f4c2f246d08c887128117435fdd439/IAR_UI_SDK.zip?raw=true' }
