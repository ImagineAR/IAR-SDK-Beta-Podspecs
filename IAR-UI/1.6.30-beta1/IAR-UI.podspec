...
Pod::Spec.new do |s|
  s.name             = 'IAR-UI'
  s.version          = '1.6.30-beta1'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/4efcaca2a213b7ee2c48cf0544305fbcdf9735e0/IAR_UI_SDK.zip?raw=true' }
