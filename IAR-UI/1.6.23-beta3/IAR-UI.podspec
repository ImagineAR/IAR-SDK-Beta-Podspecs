...
Pod::Spec.new do |s|
  s.name             = 'IAR-UI'
  s.version          = '1.6.23-beta3'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/d7fc1a1e4ed25693f4ce919cdbeb7bb7f66f2f92/IAR_UI_SDK.zip?raw=true' }
