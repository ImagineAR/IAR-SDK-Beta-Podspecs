...
Pod::Spec.new do |s|
  s.name             = 'IAR-UI'
  s.version          = '1.6.23-beta4'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/2ce5364a73f53a8f7570d451fe0ce74c863f74b8/IAR_UI_SDK.zip?raw=true' }
