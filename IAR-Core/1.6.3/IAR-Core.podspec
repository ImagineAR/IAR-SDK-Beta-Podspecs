...
Pod::Spec.new do |s|
  s.name             = 'IAR-Core'
  s.version          = '1.6.3'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/0d5b0e7e66895d49c9a08c0e5debebec758dbdbb/IAR_Core_SDK.zip?raw=true' }
