...
Pod::Spec.new do |s|
  s.name             = 'IAR-Core'
  s.version          = '1.6.0-beta1'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/0486c15b518fa30696a74373529aca259c44b72c/IAR_Core_SDK.zip?raw=true' }
