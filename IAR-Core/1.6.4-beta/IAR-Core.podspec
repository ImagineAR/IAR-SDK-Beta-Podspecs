...
Pod::Spec.new do |s|
  s.name             = 'IAR-Core'
  s.version          = '1.6.4-beta'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/04ef3f5abd164ee49da90711ba0dbc9fa03eb7b2/IAR_Core_SDK.zip?raw=true' }
