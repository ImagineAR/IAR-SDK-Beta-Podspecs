...
Pod::Spec.new do |s|
  s.name             = 'IAR-Core'
  s.version          = '1.6.1-beta3'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/e14f4111dfbbeaf90b2d20eeb215258599ab2dc1/IAR_Core_SDK.zip?raw=true' }
