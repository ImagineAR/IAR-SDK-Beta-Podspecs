...
Pod::Spec.new do |s|
  s.name             = 'IAR-Core'
  s.version          = '1.6.2-beta1'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/e8df5c34bd8b8fc31915b5fa1cd9ec7b52d8f47a/IAR_Core_SDK.zip?raw=true' }
  ...
  s.dependency 'SCNRecorder',        '~> 2.7'      # https://github.com/gorastudio-ceo/SCNRecorder/
