...
Pod::Spec.new do |s|
  s.name             = 'IAR'
  s.version          = '1.6.10-beta1'   # format 1.5.0
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/b7404ff7561c781cedd8cab08a94785f1c36d27d/IAR-SDK.zip?raw=true' }
  s.swift_version    = '5.3.1'

  s.ios.deployment_target = '12.0'
  
  s.dependency 'IAR-Core',    '1.6.10-beta1'
  s.dependency 'IAR-Surface', '1.6.10-beta1'
  s.dependency 'IAR-Target',  '1.6.10-beta1'
  s.dependency 'IAR-NFC',     '1.6.10-beta1'
end
