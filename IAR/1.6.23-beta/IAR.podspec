...
Pod::Spec.new do |s|
  s.name             = 'IAR'
  s.version          = '1.6.23-beta'   # format 1.5.0
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/1a9ba695f25bd38f0de07c8a6cf102c806da1246/IAR-SDK.zip?raw=true' }
  ...
  s.dependency 'IAR-NFC',     '1.6.23-beta'
end
