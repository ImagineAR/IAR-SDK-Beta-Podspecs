...
Pod::Spec.new do |s|
  s.name             = 'IAR'
  s.version          = '1.6.23-beta2'   # format 1.5.0
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/0a665b1cf9f4c2f246d08c887128117435fdd439/IAR-SDK.zip?raw=true' }
  s.swift_version    = '5.3.1'

  s.ios.deployment_target = '12.0'
  
  s.dependency 'IAR-Core',    '1.6.23-beta2'
  s.dependency 'IAR-Surface', '1.6.23-beta2'
  s.dependency 'IAR-Target',  '1.6.23-beta2'
  s.dependency 'IAR-NFC',     '1.6.23-beta2'
end
