...
Pod::Spec.new do |s|
  s.name             = 'IAR'
  s.version          = '1.6.30-beta1'   # format 1.5.0
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/4efcaca2a213b7ee2c48cf0544305fbcdf9735e0/IAR-SDK.zip?raw=true' }
  s.swift_version    = '5.3.1'

  s.ios.deployment_target = '12.0'
  
  s.dependency 'IAR-Core',    '1.6.30-beta1'
  s.dependency 'IAR-Surface', '1.6.30-beta1'
  s.dependency 'IAR-Target',  '1.6.30-beta1'
  s.dependency 'IAR-NFC',     '1.6.30-beta1'
end
