...
Pod::Spec.new do |s|
  s.name             = 'IAR'
  s.version          = '1.6.23-beta4'   # format 1.5.0
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/2ce5364a73f53a8f7570d451fe0ce74c863f74b8/IAR-SDK.zip?raw=true' }
  s.swift_version    = '5.3.1'

  s.ios.deployment_target = '12.0'
  
  s.dependency 'IAR-Core',    '1.6.23-beta4'
  s.dependency 'IAR-Surface', '1.6.23-beta4'
  s.dependency 'IAR-Target',  '1.6.23-beta4'
  s.dependency 'IAR-NFC',     '1.6.23-beta4'
end
