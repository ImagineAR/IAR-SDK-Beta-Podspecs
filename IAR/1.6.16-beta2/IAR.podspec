...
Pod::Spec.new do |s|
  s.name             = 'IAR'
  s.version          = '1.6.16-beta2'   # format 1.5.0
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/74fd463035e916cd69031f6e76600e2ba847ba6b/IAR-SDK.zip?raw=true' }
  ...
  s.dependency 'IAR-NFC',     '1.6.16-beta2'
end
