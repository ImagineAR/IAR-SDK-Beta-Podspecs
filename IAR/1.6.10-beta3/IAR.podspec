...
Pod::Spec.new do |s|
  s.name             = 'IAR'
  s.version          = '1.6.10-beta3'   # format 1.5.0
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/982577266185b61839686f34e5a3b4219ec81b5c/IAR-SDK.zip?raw=true' }
  s.swift_version    = '5.3.1'

  s.ios.deployment_target = '12.0'
  
  s.dependency 'IAR-Core',    '1.6.10-beta3'
  s.dependency 'IAR-Surface', '1.6.10-beta3'
  s.dependency 'IAR-Target',  '1.6.10-beta3'
  s.dependency 'IAR-NFC',     '1.6.10-beta3'
end
