...
Pod::Spec.new do |s|
  s.name             = 'IAR-Surface'
  s.version          = '1.6.10-beta5'   # format 1.5.0-beta5
...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/fb3d2e3451b4241d3da878c10c8fcdb852450c0f/IAR_Surface_SDK.zip?raw=true' }
