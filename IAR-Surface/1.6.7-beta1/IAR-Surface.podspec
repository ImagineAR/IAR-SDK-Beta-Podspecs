...
Imagine AR is a native library to facilitate the addition of augmentented reality assets with Vuforia and IAR cloud.
  ...
  s.source           = { :http => 'https://github.com/ImagineAR/IAR-SDK-Binaries/blob/99eb7b75398c0bd74eceb40521ab29a82eb1730f/IAR_Surface_SDK.zip?raw=true' }
  ...
  s.dependency  'SCNRecorder'      , '~> 2.8.1'   # https://github.com/gorastudio-ceo/SCNRecorder
